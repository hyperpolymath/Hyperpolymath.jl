...
doctor:
    @echo "Running diagnostics for Hyperpolymath.jl..."
...
help-me:
    @echo "=== Hyperpolymath.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/Hyperpolymath.jl/issues/new"
    @echo ""
