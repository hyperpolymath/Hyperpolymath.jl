...
= Hyperpolymath.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/Hyperpolymath.jl
cd Hyperpolymath.jl
...
* https://github.com/hyperpolymath/Hyperpolymath.jl/issues — report bugs
